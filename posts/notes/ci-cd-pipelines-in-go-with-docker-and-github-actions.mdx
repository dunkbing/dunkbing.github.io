...
![Create Secret DOCKER_USERNAME](/images/notes/create_secret_docker_username_ga.png)
_Create Secret DOCKER\_USERNAME_

![Create Secret DOCKER_ACCESS_TOKEN](/images/notes/create_secret_docker_access_token_ga.png)
_Create Secret DOCKER\_ACCESS\_TOKEN_

![Secrets for pipeline](/images/notes/secret_for_pipeline.png)
...
![Github Action test fail_](/images/notes/ga_build_fail.png)
...
![Github Action test fail_](/images/notes/ga_test_successfully.png)
_Github Action test successfully_

![Github Action test fail_](/images/notes/ga_status.png)
