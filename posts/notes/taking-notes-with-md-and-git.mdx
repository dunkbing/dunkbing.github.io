---
title: 'Enhancing Note-Taking Efficiency: Neovim, Markdown, and Git/GitHub'
description: 'Enhancing Note-Taking Efficiency: Neovim, Markdown, and Git/GitHub'
publishedTime: '2024-02-03'
modifiedTime: '2024-02-03'
...
![notes](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/qu6hf0f8jwxg2uwdy5e3.png)

2. Navigate to the folder I want to work on and open Neovim. I'm using Lazyvim btw, it has a plugin pre-installed called NeoTree that shows me a file explorer on the left side of the screen.
3. Write my notes with markdown, and push the changes to GitHub, where I can access them from any device. You can also set up a crontab to run the sync command periodically, something like mine:


![sync](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/eccch9q1v9aozumek6p2.png)
